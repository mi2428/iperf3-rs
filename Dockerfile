...
ARG IPERF3_BUILD_DATE
ARG IPERF3_GIT_COMMIT
ARG IPERF3_GIT_COMMIT_DATE
ARG IPERF3_GIT_DESCRIBE
ENV IPERF3_BUILD_DATE=${IPERF3_BUILD_DATE}
ENV IPERF3_GIT_COMMIT=${IPERF3_GIT_COMMIT}
ENV IPERF3_GIT_COMMIT_DATE=${IPERF3_GIT_COMMIT_DATE}
ENV IPERF3_GIT_DESCRIBE=${IPERF3_GIT_DESCRIBE}

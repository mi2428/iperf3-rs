...
Variables:
  TAG                    Release tag for make release, for example v1.0.2
...
Examples:
  ...
  make release TAG=v1.0.2                      # to publish crates.io and push the release tag
...
Run `make release TAG=v1.0.2` to publish the crate to crates.io and push the release tag that drives cargo-dist.
...
Publishing a tag such as `v1.0.2` runs `.github/workflows/release.yml`.
